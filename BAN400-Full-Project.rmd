...
library(scales) # TFormatting library
...
library(tbl2xts) # Format fromt able to xts object
...
plot_stock <- function(company){
  index <- company %>% match(stock_data$company_name)
  stock_to_plot <- stock_data$ticker[index]
  chart_name <-  paste(company)
